...
class PalettePicker extends React.Component {
  ...
  render() {
    ...
    for ( let i = 0; i < palette.length; i += 1 ) {
      ...
      if ( i === 0 ) {
        // hacks
        style.background = 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(255,50,0,1) 100%)';
      }
    ...
    if ( selectedIndex === 0 ) {
      // hacks
      editButtonStyle.background = 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(255,50,0,1) 100%)';
    }
