...
class TileSelectorCanvas extends React.Component {
  ...
  render() {
    ...
    const style = {
      ...
      'background-image':
        'linear-gradient(to right, rgba(0, 0, 0, 0.25) 10px, transparent 10px),'
        + 'linear-gradient(to bottom, rgba(0, 0, 0, 0.25) 10px, transparent 10px)',
